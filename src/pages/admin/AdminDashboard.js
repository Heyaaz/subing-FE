    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <button
            onClick={() => navigate('/admin/optimization-config')}
            className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow text-left"
          >
            ...
            <h3 className="text-lg font-semibold text-gray-900">최적화 정책</h3>
            <p className="text-sm text-gray-600 mt-1">전역 최적화 파라미터 운영 및 롤백</p>
          </button>
        </div>
